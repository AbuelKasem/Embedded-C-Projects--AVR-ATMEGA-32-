...
FreeRTOS/Src/%.o: ../FreeRTOS/Src/%.c
	...
	avr-gcc -I"C:\Users\AbuElkasem\ECLIPSworks\Rtos_binarySemaphore_Resource\FreeRTOS" -I"C:\Users\AbuElkasem\ECLIPSworks\Rtos_binarySemaphore_Resource\FreeRTOS\Inc" -Wall -Os -fpack-struct -fshort-enums -ffunction-sections -fdata-sections -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega32 -DF_CPU=8000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
